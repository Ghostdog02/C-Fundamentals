...
namespace Program
{
    public class UndirectedGraph
    {
        ...
        public int V { get => nbVertices; }

        public int E { get => nbEdges; private set => nbEdges = value; }
        ...
        public void DFS(int src, bool[] visited, int parent)
        {
            visited[src] = true;
            if (parent != -1)
                Console.WriteLine($"{parent} -> {src}");
            else
